#import "GTSGridOptionsViewController.h"
...
@interface GTSGridOptionsViewController () <UITableViewDelegate, UITableViewDataSource, UIPickerViewDelegate, UIPickerViewDataSource>
{
...
@implementation GTSGridOptionsViewController
...
- (id)init
{
    if ((self = [super init])) 
    {
        self.title = NSLocalizedString(@"GRID_OPTS", nil);
    }
    return self;
}
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section
{
    ...
    switch (section) 
    {
        case OptionSectionGeneral:
            title = NSLocalizedString(@"GRID_OPTS_GENERAL", nil);
            break;
        case OptionSectionLayout:
            title = NSLocalizedString(@"GRID_OPTS_LAYOUT", nil);
            break;
        case OptionSectionSorting:
            title = NSLocalizedString(@"GRID_OPTS_SORTING", nil);
            break;
        case OptionSectionGestures:
            title = NSLocalizedString(@"GRID_OPTS_GESTURES", nil);
            break;
        case OptionSectionDebug:
            title = NSLocalizedString(@"GRID_OPTS_DEBUG", nil);
            break;
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([indexPath section] == OptionSectionGeneral)
    {
        switch ([indexPath row]) 
        {
            ...
            {
                cell.detailTextLabel.text = NSLocalizedString(@"GRID_OPTS_GENERAL_EDITING", nil);
    ...
    else if ([indexPath section] == OptionSectionLayout) 
    {
        switch ([indexPath row]) 
        {
            ...
            {
                cell.detailTextLabel.text = NSLocalizedString(@"GRID_OPTS_LAYOUT_CENTER", nil);
            ...
            {
                cell.detailTextLabel.text = NSLocalizedString(@"GRID_OPTS_LAYOUT_SPACING", nil);
            ...
            {
                cell.detailTextLabel.text = NSLocalizedString(@"GRID_OPTS_LAYOUT_INSETS", nil);
    ...
    else if ([indexPath section] == OptionSectionSorting)
    {
        switch ([indexPath row]) 
        {
            ...
            {
                cell.detailTextLabel.text = NSLocalizedString(@"GRID_OPTS_SORTING_STYLE", nil);
                
                UISegmentedControl *segmentedControl = [[UISegmentedControl alloc] initWithItems:[NSArray arrayWithObjects:NSLocalizedString(@"GRID_OPTS_SORTING_STYLE_SWAP", nil), NSLocalizedString(@"GRID_OPTS_SORTING_STYLE_PUSH", nil), nil]];
    ...
    else if ([indexPath section] == OptionSectionGestures)
    {
        switch ([indexPath row]) 
        {
            ...
            {
                cell.detailTextLabel.text = NSLocalizedString(@"GRID_OPTS_GESTURES_EDIT", nil);
            ...
            {
                cell.detailTextLabel.text = NSLocalizedString(@"GRID_OPTS_GESTURES_DISABLE", nil);
    ...
    else if ([indexPath section] == OptionSectionDebug)
    {
        switch ([indexPath row]) 
        {
            ...
            {
                cell.detailTextLabel.text = NSLocalizedString(@"GRID_OPTS_DEBUG_BACKGROUND", nil);
            ...
            {
                cell.detailTextLabel.text = NSLocalizedString(@"GRID_OPTS_DEBUG_RELOAD", nil);
                ...
                [reloadButton setTitle:NSLocalizedString(@"GRID_OPTS_RELOAD", nil) forState:UIControlStateNormal];
...
- (NSString *)pickerView:(UIPickerView *)pickerView titleForRow:(NSInteger)row forComponent:(NSInteger)component
{
    ...
    switch (row) {
        case 0:
            title = @"GRID_OPTS_LAYOUT_STRATEGY_VERTICAL";
            break;
        case 1:
            title = @"GRID_OPTS_LAYOUT_STRATEGY_HORIZONTAL";
            break;
        case 2:
            title = @"GRID_OPTS_LAYOUT_STRATEGY_PAGED_LTR";
            break;
        case 3:
            title = @"GRID_OPTS_LAYOUT_STRATEGY_PAGED_TTB";
            break;
        default:
            title = @"Unknown";
            break;
