...
@interface GTSGridController () <GMGridViewDataSource, GMGridViewSortingDelegate, GMGridViewTransformationDelegate, GMGridViewActionDelegate>
{
...
@implementation GTSGridController


- (void)awakeFromNib {

	self.title = NSLocalizedString(@"CATALOG_TITLE", nil);
...
//    [self.view addSubview:dataSegmentedControl];
    ...
    GTSGridOptionsViewController *optionsController = [[GTSGridOptionsViewController alloc] init];
...
- (GMGridViewCell *)GMGridView:(GMGridView *)gridView cellForItemAtIndex:(NSInteger)index
{
    ...
    if (!cell) 
    {
        ...
        cell.deleteButtonIcon = [UIImage imageNamed:@"close-x.png"];
