...
@property (nonatomic, strong, readonly) APNavigationControllerForSplitController *master;
@property (nonatomic, strong, readonly) APNavigationControllerForSplitController *detail;
